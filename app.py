...
# --- PANEL PRINCIPAL ---
    ...
    try:
        ...
        # Gráfico: 10 Rojo, 1 Verde
        st.subheader("📊 Tendencia Semanal de Esfuerzo")
        ...
        with c1:
            ...
            else: st.write("Esperando registros...")
        ...
        with c2:
            ...
            st.write(", ".join(pendientes) if pendientes else "¡Todo el equipo listo! ✅")
